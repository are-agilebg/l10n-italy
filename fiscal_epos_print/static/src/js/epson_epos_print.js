    ...
    var eposDriver = core.Class.extend({
        ...
        */
        printFiscalRefundDetails: function (args) {
            var info_refund_date = args.refund_date.split("-");
            var message =
                "REFUND " +
        ...
        */
        printInfoPaymentCustomer: function (receipt) {
            var tag =
                '<printRecMessage operator="1" message="------------------" messageType="3" index="4" font="2" />';
            var c = 2;
        ...
        */
        printFiscalReceipt: function (receipt) {
            ...
            if (receipt.lottery_code) {
                ...
                xml +=
                    '<printRecLotteryID operator="' +
                    (receipt.operator || "1") +
                    '" code="' +
                    receipt.lottery_code +
                    '" />';
            }
